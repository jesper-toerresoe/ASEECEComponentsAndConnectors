...
namespace ST3ITS3ExServiceRequester.Util.JSON
{
    public class ST3P3ExServiceUtilJSON
    {
        ...
        public ST3P3ExServiceUtilJSON(string hname, string portno, string serpath)
        {
            portnumber = portno;
